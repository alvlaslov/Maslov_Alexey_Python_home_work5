...
print(f"The game 'Take all the candies!' welcomes you.\n"
      ...
      f"Let's go!!!")
fp_name = input('First player introduce yourself: ')
sp_name = input('Second player introduce yourself: ')
pos = randint(0, 1)
if pos > 0:
    print(f'Congratulations!!! {fp_name}, you go first.')
else:
    print(f'Congratulations!!! {sp_name}, you go first.')
fp_counter = 0
sp_counter = 0
while box > max_pos:
    if pos:
